...
namespace BoostStreamServer.Controllers
{
    [ApiController]
    [Route("api")]
    public class APIController : ControllerBase
    {
        ...
        public APIController(IWebHostEnvironment appEnvironment, ILogger<APIController> logger, ApplicationDbContext context)
        {
        ...
        public void Telemetry([FromForm]TelemetryMessage telemetry)
        {
            ...
            {
                var userFromDB = db.Users.FirstOrDefault(x => x.UserName == telemetry.Login);
        ...
        public string GetAccess(string login, string password)
        {
            ...
            {
                var userFromDB = db.Users.FirstOrDefault(x => x.UserName == login && x.Password == password);
        ...
        public bool signin([FromForm]AuthUser user)
        {
            ...
            {
                var userFromDB = db.Users.FirstOrDefault(x => x.UserName == user.Login && x.Password == user.Password);
